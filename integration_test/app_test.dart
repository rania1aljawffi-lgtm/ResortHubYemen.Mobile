...
void main() {
  ...
  group('End-to-End App Integration & Flow Verification', () {
    testWidgets('Complete Critical User Flow and Navigation Verification', (WidgetTester tester) async {
      ...
      // 4. Navigation to Chalets Screen (via Bottom Nav or Route)
      ...
      expect(find.text('تسجيل الوصول'), findsOneWidget);
      expect(find.text('تسجيل المغادرة'), findsOneWidget);
